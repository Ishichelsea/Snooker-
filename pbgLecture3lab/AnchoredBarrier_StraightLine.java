...
public class AnchoredBarrier_StraightLine extends AnchoredBarrier {
	...
	private final Vect2D unitNormal,unitTangent;
    private Vect2D endPos, startPos;
	private Color col;
	...
	public AnchoredBarrier_StraightLine(double startx, double starty, double endx, double endy, Color col) {
		this(startx, starty, endx, endy, col, 0.0);
	}
    ...
    public void setEndPos(Vect2D pos) {
        this.endPos = pos;
    }

    public void setStartPos(Vect2D pos) {
        this.startPos = pos;
    }
